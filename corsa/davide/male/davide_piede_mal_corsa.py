...
cap = cv2.VideoCapture("piedi.mp4")
...
while True:
    ...
    if lmList:
        try:
            ...
            with open('piede_dav_mal_corsa.csv', 'a', newline='') as file:  # se tallone sinitro è in piu in basso di punta piede sinistro corre male
