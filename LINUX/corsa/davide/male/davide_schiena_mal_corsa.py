...
cap = cv2.VideoCapture("schiena.mp4")
...
while True:
    ...
    with open('schiena_dav_mal_corsa.csv', 'a', newline='') as file:  # se tallone sinitro è in piu in basso di punta piede sinistro corre male
