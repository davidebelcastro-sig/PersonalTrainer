...
while True:
    ...
    with open('volto_dav_bn_corsa.csv', 'a', newline='') as file:
    ...
    with open('schiena_dav_bn_corsa.csv', 'a', newline='') as file:  # se tallone sinitro è in piu in basso di punta piede sinistro corre male
        writer = csv.writer(file)
    ...
    with open('piede_dav_bn_corsa.csv', 'a', newline='') as file:  # se tallone sinitro è in piu in basso di punta piede sinistro corre male
        writer = csv.writer(file)
    ...
    with open('gomito_dav_bn_corsa.csv', 'a', newline='') as file:  # se tallone sinitro è in piu in basso di punta piede sinistro corre male
        writer = csv.writer(file)
