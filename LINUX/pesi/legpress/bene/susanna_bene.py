...
cap = cv2.VideoCapture("./video/legpress_bene.mov")
...
while True:
    ...
    with open('./bene/piedi_bn_sus_leg.csv', 'a', newline='') as file:
    ...
    with open('./bene/scende_bn_sus_leg.csv', 'a', newline='') as file: 
        writer = csv.writer(file)
